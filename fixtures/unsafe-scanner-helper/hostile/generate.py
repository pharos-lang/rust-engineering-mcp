...
def main() -> None:
    ...
    # 40k keeps every defined case below the admitted 1 MiB source-file bound;
    # larger explicit requests remain valid only when every case still fits.
    parser.add_argument("--depth", type=int, default=40_000)
