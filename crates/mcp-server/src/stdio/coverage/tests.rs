...
//! mapping. The instrumented run itself is qualified by evidence tracked in
//! `docs/development/testing.md` (historical receipt: docs/validation/M3/runtime.json
//! at 51fa602e); everything asserted here is portable.
use super::*;
