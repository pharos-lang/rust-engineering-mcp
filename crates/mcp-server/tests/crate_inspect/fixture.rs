...
pub fn records() -> Vec<CrateRecord> {
    ...
    old.advisories = vec!["RUSTSEC-2020-0001".into(), "RUSTSEC-2020-0002".into()];
    old.features = vec!["gamma".into(), "alpha".into(), "beta".into()];
...
pub fn bundle(sequence: u64) -> Result<Vec<u8>, Box<dyn std::error::Error>> {
    let provenance = Provenance::new(
        SourceKind::RegistrySnapshot,
        "local-inspect-fixture".parse()?,
