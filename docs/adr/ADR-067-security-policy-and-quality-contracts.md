...
El binario medido usó Tasks; G1 y G4 acreditan separadamente la ruta síncrona del
candidato final. Los recibos crudos conservan digest, bytes y muestras individuales.

| Tool | Régimen | n | p50 ms | p95 ms | p99/máximo ms |
| --- | --- | --- | --- | --- | --- |
| `rust.deny` | cold | 30 | 6393.5 | 7125 | 7873 |
| `rust.deny` | warm | 30 | 6408.0 | 7026 | 7918 |
| `rust.miri` | cold | 30 | 8670.5 | 9446 | 9865 |
| `rust.miri` | warm | 30 | 8704.0 | 9440 | 9515 |
| `rust.quality.gate.v2` | cold | 30 | 13856.0 | 16233 | 17044 |
| `rust.quality.gate.v2` | warm | 30 | 13858.0 | 15168 | 15263 |
| `rust.supply_chain.inspect` | cold | 30 | 6439.5 | 7045 | 7780 |
| `rust.supply_chain.inspect` | warm | 30 | 6420.0 | 7047 | 7640 |
| `rust.unsafe.scan` | cold | 30 | 5564.0 | 6091 | 6730 |
| `rust.unsafe.scan` | warm | 30 | 5564.5 | 5990 | 5997 |

El máximo observado fue 17044 ms. Se conserva el techo síncrono de trabajo de
60 s heredado de M3, excluyendo cleanup unido, con presupuesto solicitado
explícito <=60 s. Auto sin Tasks usa la misma selección; auto con Tasks negocia
un job. Los defaults siguen siendo 120 s para deny/scan/supply y 300 s para
Miri/gate.v2, por lo que un peer sin Tasks recibe TasksRequired por defecto.
Gate.v2 solo califica síncrono para strict sin mutation. Release, mutation y
selecciones largas requieren Tasks. Las mediciones no prometen terminar cualquier
proyecto en 60 s: el exceso conserva timeout/incomplete y cleanup obligatorio.
