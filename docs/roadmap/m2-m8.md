...
Estado: **M2–M6 Done; M7 Deferred con decisión; M8 en curso**. Fecha de planificación: 2026-09-05. Este documento es backlog,
...
| [M3](m3-quality.md) | Done; [matriz de cierre](../validation/M3/matrix.md), integrado en `main` (PR #14, `57c40373597541ac3d57bc8446ec4e2e598b904e`) | Cierre real M2; ejecución y persistencia de tareas decididas | nextest, cobertura, SemVer, mutation testing; 0.3.x | XL |
| [M4](m4-security.md) | Done; [handoff](../validation/M4/handoff.md), integrado en `main` (PR #15, `90d72f2c4727e2487e9281623ed8e0860b392c91`) | M3 cerrado; fuentes y runtime de seguridad calificados | deny, unsafe, Miri, supply chain y hardening; 0.4.x | XL |
| [M5](m5-performance.md) | Done; [handoff](../validation/M5/handoff.md), integrado en `main` (PR #17, `6ea330debc27a2cf1564fbbc258d4b358f5b0f1a`; release `v0.3.0` vía PR #18) | M4 cerrado; protocolo de medición congelado | benchmark/compare/flamegraph/bloat; 0.5.x | L |
| [M6](m6-analyzer.md) | Done; [handoff](../validation/M6/handoff.md) y [g-disposition](../validation/M6/g-disposition.md), integrado en `main` (PR #20, `e50c3fefaff03fc45b89ae899cf5736af1fd0a72`) | M5 cerrado; M2 válido para acciones, M3 para lifecycle | Adapter rust-analyzer y evidencia semántica; 0.6.x | XL |
| [M7](m7-remote.md) | **Deferred con decisión** ([acta M7-G0](m7-g0-decision.md), 2026-09-13) | M6 cerrado y caso real aprobado | No-go del owner por falta de expediente; sin release 0.7.x. Reevaluable con expediente completo + Go | XL solo si Go |
...
1. [Implementar y cerrar M2](../prompts/history/implement-m2.md).
2. [Implementar y cerrar M3](../prompts/history/implement-m3.md).
3. [Implementar y cerrar M4](../prompts/history/implement-m4.md).
4. [Implementar y cerrar M5](../prompts/history/implement-m5.md).
