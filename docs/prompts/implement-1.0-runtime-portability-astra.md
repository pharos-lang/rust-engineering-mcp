...
[especificación](../spec/rust-engineering-mcp-propuesta-v0.3.md),
[AGENTS.md](../../AGENTS.md), el [tablero](../implementation-status.md), las
...
- [ADR-048: frontera de artifact](../adr/ADR-048-0.1.0-qualification-and-artifact-boundary.md),
  [ADR-050: mutación coordinada](../adr/ADR-050-local-coordinated-mutation.md) y
  [ADR-087: alcance actual de hosts](../adr/ADR-087-1.0-host-scope.md).
...
- [Admisión M5](../adr/ADR-077-m5-runtime-admission.md),
  [aprovisionamiento M6](../adr/ADR-082-m6-runtime-provisioning.md) y
  [admisión M6](../adr/ADR-085-m6-runtime-admission.md).
- [Compatibilidad](../compatibility.md), [tools](../tools.md),
  [modelo de seguridad](../security-model.md), [CI](../ci.md),
  [publicación](../publication.md) y [configuración](../client-configuration.md).
- [Política de evidencia](../validation/README.md), matriz/handoff vigentes M8,
...
`docs/implementation-status.md` sigue siendo el tablero repo-visible, con una
sección RUP y enlaces al paquete. Mantener allí la leyenda existente.
...
> Ejecuta `docs/prompts/implement-1.0-runtime-portability-astra.md` con GPT-6
...
> Retoma el mismo plan desde `docs/validation/RUP-1.0/handoff.md` y
