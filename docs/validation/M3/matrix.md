...
| G2 Autoridad y threat model | Done | V-SEC fue dispuesto y rust-security pasa 20/20. El M3 orchestrator aceptó ADR-064 y ADR-065 el 2026-09-06, después de la revisión independiente de seguridad y de los gates runtime/Rust-security; la aceptación delegada está registrada en [D03-adr-acceptance](delegation/D03-adr-acceptance/). La autorización separada del owner del 2026-09-05 cubría guest provisioning, no estas decisiones. |
...
| G8 Revisión independiente y bug bar | Done | V-SEC y V-CONTRACTS previos fueron dispuestos. Los re-reviews [VR-CONTRACTS](delegation/VR-contracts-rereview/last-message.md) y [VR Opus](delegation/VR-opus-rereview/last-message.md) confirmaron que los hallazgos bloqueantes están corregidos; los residuos aceptados quedan registrados en esta matriz. |
