...
| [I02-integration](I02-integration/prompt-header.md) | Claude Sonnet 5 (Low) | Cinco commits de M8-02 (ADR-087; freeze Rust + versión; oráculo Python + gate; docs; paquete M8) y commit de evidencia regenerada post-commit | En curso |
