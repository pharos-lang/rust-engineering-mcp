...
known product label. The [machine report](17-final-gate/full-report.json),
[complete log](m1-17-final-gate/full.log) and [receipt](17-final-gate/receipt.json)
retain commands, source/dirty declaration, platform, versions, status and hashes.
The [derived count receipt](17-final-gate/counts-derived-from-log.json) reports
...
advisories in [audit-focused.json](17-final-gate/audit-focused.json). The base
...
A broader seven-pattern [credential scan](17-final-gate/secret-scan-followup.json)
