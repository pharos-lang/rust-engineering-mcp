...
| [W14-analyzer-coverage-tests](W14-analyzer-coverage-tests/prompt-header.md) | Claude Opus 5 (High) | 19 tests unitarios portables para las funciones puras de `analyzer_gateway`/`analyzer_action` (convert, error-maps, output builders) — sube new_coverage 78.1%→~81% en el llvm-cov de Linux de SonarCloud | **Entregado** (~320 líneas, fmt/clippy/test verdes) |
