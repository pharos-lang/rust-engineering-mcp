...
| M4 / 0.4.x | In progress | [Security](roadmap/m4-security.md) · [prompt M4](prompts/implement-m4.md) |
...
**Calificación completa; confirmación independiente final pendiente.**
...
| [Full](validation/M4-full-gate.json) | 33/33 reanudado sobre los mismos 987 inputs: 27 pasos conservados y seis ejecutados tras recuperar assets E5 locales exactos; sin descarga ni cambios de código/oráculos. |
...
| [Clientes](validation/M4-clients.json) | Intento 4 PASS: Inspector 2.5.0 y Codex stock 0.153.0, cinco tools reales y Resources; Tasks/cancelación en Inspector, sync/modelo en Codex. |
...
ni P2 nuevos. La renovación nativa resuelve la evidencia stale retenida; falta
confirmación independiente y disposición final. Se preservan fallos e intentos
