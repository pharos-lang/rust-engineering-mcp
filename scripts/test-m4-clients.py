...
ATTEMPTS = ROOT / "target/qualification/test-m4-clients/clients"
CURRENT = ROOT / "target/qualification/test-m4-clients/clients.json"
PREFLIGHT = ROOT / "target/qualification/test-m4-clients/clients-pre-advertisement.json"
...
def source_hashes() -> dict[str, str]:
    ...
    paths = (M3_PATH, ROOT / "scripts/m3-inspector-session.mjs",
             ...
             SESSION, UNIT, ROOT / "scripts/lib/codex_client_controller.py")
...
def codex_gate(attempt: pathlib.Path, socket: str, fixture: dict, codex: pathlib.Path) -> dict:
    ...
    controller_path=ROOT/"scripts/lib/codex_client_controller.py"
