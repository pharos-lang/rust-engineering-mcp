...
assert tomllib.loads((root/'rust-toolchain.toml').read_text(encoding='utf-8'))['toolchain']['channel']=='1.98.1'
...
if qualified.group(1)=='true':
    receipt=root/'qualification/benchmark-method-simulation.json'
