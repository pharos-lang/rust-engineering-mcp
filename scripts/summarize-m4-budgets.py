...
def main():
    ...
    dest=ROOT/"target/qualification/m4-budgets";dest.mkdir(parents=True,exist_ok=True)
    ...
    (ROOT/"target/qualification/m4-budgets.json").write_text(json.dumps(summary,indent=2)+"\n")
